...
import com.example.unsplash.data.local.dao.UnsplashDatabase
...
class UnsplashRemoteMediator @Inject constructor(private val unsplashApi: UnsplashApi, private val unsplashDatabase: UnsplashDatabase)
    ...
    override suspend fun load(
        ...
        return try {
            ...
            val response = unsplashApi.getAllImages(page = currentPage, perPage = Constants.ITEMS_PER_PAGE)
